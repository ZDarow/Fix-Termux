...
### ✨ Новые возможности v3.7

#### Интеграция Launcher в Главное Меню

**🔧 Обновление:**
- Добавлена опция **L) Запустить Launcher** в главное меню
- Быстрый запуск меню инструментов из Fix-Termux
- `exec bash launcher.sh` — замена процесса (без возврата)

**📋 Главное меню:**
```
  P) Профили установки
  U) Проверить обновления
  L) Запустить Launcher ← NEW!
  S) Настройки
  T) Статистика
```
...
bash Fix-Termux.sh
# Выбрать: L
# Запустится Launcher со всеми инструментами
```
